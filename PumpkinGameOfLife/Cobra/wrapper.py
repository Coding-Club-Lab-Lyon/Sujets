...
# Fonctions utilitaires pour les lycéens

def compter_voisins(grille, ligne, colonne):
    """
    Compte le nombre de citrouilles voisines autour d'une position
    
    Args:
        grille: la grille du jeu (liste de listes)
        ligne: numéro de ligne de la cellule
        colonne: numéro de colonne de la cellule
...
def creer_grille_vide(largeur, hauteur):
    """
...
def afficher_grille_console(grille):
    """
    Affiche la grille dans la console (utile pour déboguer)
    
    Args:
        grille: la grille à afficher
    """
    for ligne in grille:
