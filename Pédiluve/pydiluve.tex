...
\Intro{
    ...
    {\comfortaa
        ...
        tu vas pouvoir faire du sale, mais remettons les choses à plats:
        \newline
...
{\comfortaa
    ...
    \Warning{
    Ce code est un exemple tres simpliste, il te montre seulement quelques fonctions de \textbf{turtle}. 
